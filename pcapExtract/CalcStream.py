...
print("Total packages:", len(pcaps))
print("Total short stream packages:", len(short_pcaps))
print("Total "+str(long_stream_count)+" long stream sessions")
print("Total "+str(long_stream)+" long stream length")
print("Total "+str(short_stream_count)+" short stream sessions")
print("Total "+str(short_stream)+" short stream length")
#
