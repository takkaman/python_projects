...
Revision ID: aeebd72d84f4
Revises: dc7af681579e
Create Date: 2018-04-29 12:52:35.108000
...
revision = 'aeebd72d84f4'
down_revision = 'dc7af681579e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('carprice', sa.Text(), nullable=True),
